...
#define HEADER_NORMAL_TITLE @"下拉即可刷新"
#define HEADER_DRAGGING_TITLE @"松手即可刷新"
#define HEADER_LOADING_TITLE @"正在刷新中"
#define FOOTER_NORMAL_TITLE @"拖动即可加载"
#define FOOTER_DRAGGING_TITLE @"松手即可加载"
#define FOOTER_LOADING_TITLE @"正在加载中"
